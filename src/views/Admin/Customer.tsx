import { Button, Dropdown, Input, MenuProps, Table, Tabs, TabsProps, Tag } from "antd";
import { CheckCircleOutlined, CloseCircleOutlined, DownOutlined, EditOutlined, OrderedListOutlined, PlusOutlined, SearchOutlined, StopOutlined, SyncOutlined, WarningOutlined } from "@ant-design/icons";
...
export default function Customer() {
    ...
    const columns = [
        ...
        },
        {
            ...
            className={twMerge(
                text === 'Active' ? 'border-[#379D51] text-[#379D51] bg-[#E3FFE6]' :
                 'border-[#777777] text-[#777777] bg-[#F0F1F3]', 'rounded-2xl space-x-2 font-semibold')}>{text}</Tag>
        },
        {
            title: 'Action',
           ...
           <Heading heading={"Customer "}/>
            <div className="flex space-x-[16px]">
                ...
                <Button className="flex items-center" onClick={() => setNewStaff(true)} type='primary'>
                    <span className="mt-1">New Customer</span>
                    <PlusOutlined/>
                </Button>
            </div>
           </section>
