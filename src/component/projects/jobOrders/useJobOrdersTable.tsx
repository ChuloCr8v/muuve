...
import RejectProjectChildren from "../modals.tsx/RejectProjectModal";
import SignoffProjectChildren from "../modals.tsx/SignoffProjectModal";
...
const useJobOrdersTable = ({
  setSurveyDetailsIsOpen,
  setEditJobOrder,
}: Props) => {
  ...
  const { jobOrderActionItems } = useProjectActionItems();
  ...
  return { JobTableData, handleShowPopup };
};

export default useJobOrdersTable;
