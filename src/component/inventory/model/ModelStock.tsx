import {
  ...
  import Completed from '~/assets/checkSvg.svg';
  import Rejected from '~/assets/new-declined.svg';
  import Pending from '~/assets/new-pending.svg';
  import Total from '~/assets/new-total.svg';
